...
public class Query {
	...
	private static String queryStem = SearchEngine.directory+ "SearchEnginePhaseTwo/src/documents/queryStem.txt";
	private static String queryNoStop[] = {SearchEngine.directory+ "SearchEnginePhaseTwo/src/documents/queryNoStop.txt"};
	private static String queryNoStop1 = SearchEngine.directory+ "SearchEnginePhaseTwo/src/documents/queryNoStop.txt";
